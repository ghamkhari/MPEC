...
Table=Reshaping(P_G_Resiptory,P_D_Resiptory,Theta_Resiptory,Lambda_Resiptory,Sigma_Resiptory,Delta_Resiptory,...
    ...
    R_Delta_Resiptory,R_Zeta_Resiptory,R_Xi_Resiptory);
...
optimize(Constraints, -Prob.c*Optimization_Vector, Settings)
...
Optimal_Objective_Raw=Prob.c*Res.sol.int.xx;   %%%% MPEC result 
%mean(MPEC_Object_From_Dispatch_Set)   %%%% for testing 
