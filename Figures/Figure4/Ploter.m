...
set(ax2, 'Units', 'normalized', 'Position', [0.42 0.365 0.4 0.4])

hold on
plot(.1:.1:1,Time_Solver_MILP_Set/60,'-ko')
plot(.1:.1:1,Time_Total_Set/60,'-b*')
axis([0,1,0,15])
ax2.YTick=[0:5:15];
ax2.YTickLabel=[0:5:15];
...
xlabel('Capacity of Congested Line')
ylabel('Optimality')
